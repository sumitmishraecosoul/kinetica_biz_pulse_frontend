...
const renderRow = (row: CategoriesRowData) => {
...
const CategoriesTable: React.FC<CategoriesTableProps> = ({ data, isLoading }) => {
  if (isLoading) {
    return (
  ...
  if (!data || data.length === 0) {
    return (
      <div className="text-center py-8 text-gray-600">
        No Categories data available for the selected filters.
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" colSpan={3} className="text-center py-3 px-4 text-xs font-medium text-gray-500 uppercase tracking-wider border-l border-r border-gray-200">
                Cases
              </th>
              <th scope="col" colSpan={3} className="text-center py-3 px-4 text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200">
                gSales
              </th>
              <th scope="col" colSpan={3} className="text-center py-3 px-4 text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200">
                fGP
              </th>
              <th scope="col" colSpan={2} className="text-center py-3 px-4 text-xs font-medium text-gray-500 uppercase tracking-wider">
                fGP %
              </th>
            </tr>
            <tr>
      ...
      <div className="px-4 py-3 bg-gray-50 border-t border-gray-200">
        <div className="space-y-1 text-xs text-gray-600">
          <p>- Food includes Food, Mell & CAL business units.</p>
