...
interface WSROIChannelTableProps {
  data: WSROIChannelRowData[];
  isLoading: boolean;
}
...
const renderRow = (row: WSROIChannelRowData) => {
...
const WSROIChannelTable: React.FC<WSROIChannelTableProps> = ({ data, isLoading }) => {
  if (isLoading) {
    return (
  ...
  if (!data || data.length === 0) {
    return (
      <div className="text-center py-8 text-gray-600">
        No WS ROI Channel data available for the selected filters.
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg shadow-sm overflow-hidden">
      ...
      <div className="px-4 py-3 bg-gray-50 border-t border-gray-200">
        <div className="space-y-1 text-xs text-gray-600">
          <p>- Food includes Food, Mell, and Chilled business units.</p>
...
export default WSROIChannelTable;
